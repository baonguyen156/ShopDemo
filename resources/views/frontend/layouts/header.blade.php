					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								@else
								<li><a href="{{url('/member-login')}}"><i class="fa fa-user"></i> Account</a></li>
								@endif
								<li><a href="{{url('/shop/checkout')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								<li><a href="{{url('/shop/cart')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
								@if (auth::check()==true)
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="{{url('/shop/search-advance')}}">Search Advance</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
